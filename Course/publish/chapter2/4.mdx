...
![基于单词（Word-based）的 tokenization 的示例。](./assets/word_based_tokenization.svg "An example of word-based tokenization.")
...
![基于字符（Character-based）的 tokenization 的一个示例](./assets/character_based_tokenization.svg "An example of character-based tokenization.")
...
![基于子词（subword）的 tokenization 的一个示例](./assets/bpe_subword.svg "A subword tokenization algorithm.")
