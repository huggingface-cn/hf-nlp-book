...
![An empty colab notebook](./assets/new_colab.png "An empty colab notebook")
...
![A gif showing the result of the two commands above: installation and import](./assets/install.png"A gif showing the result of the two commands above: installation and import")
