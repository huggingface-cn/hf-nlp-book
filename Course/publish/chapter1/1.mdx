...
![本书的主要章节](./assets/summary.svg "本书的主要章节")
...
- 第 5 章到第 9 章共分为两部分。第一部分第 5 章到第 8 章介绍了 🤗 Datasets 库和 🤗 Tokenizers 库的基础知识。通过这一部分的学习，您可以独自解决最常见的 NLP 问题，为深入研究经典 NLP 任务奠定基础。第二部分为第 9 章，本章将介绍如何为您的机器学习构建**交互式演示**模型，并将其优化为您自己的可分享的模型演示生产环境。
