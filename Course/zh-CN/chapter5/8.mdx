...
本章涵盖了很多方面！如果你没有掌握所有细节，不用担心；接下来的章节将帮助你了解🤗 Datasets 内在运作机制。
	...
	choices={[
		{
			...
			explain: "这是不正确的—— 流式数据集是动态解压的，你可以用非常小的 RAM 处理 TB 量级的数据集！",
		},
		{
...
<Question
	choices={[
		...
		{
			text: "能",
			explain: "正确！你可以查看🤗 Transformers 库中关于语音和视觉的发展，看看🤗 Datasets 是如何应用于这些领域中的。",
			correct: true
		},
	]}
/>
