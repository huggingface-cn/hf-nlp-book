...
在接下来的讨论中，我们会经常区分“慢速”和“快速”词元分析器。慢速词元分析器是在 🤗 Transformers 库中用 Python 编写的，而快速版本是由 🤗 Tokenizers 提供的，它们是用 Rust 编写的。如果你还记得在 [第五章](/course/chapter5/3) 中对比了快速和慢速词元分析器对药物审查数据集进行词元化所需的时间的这张表，您应该理解为什么我们称它们为“快速”和“慢速”：
